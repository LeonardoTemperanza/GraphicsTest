...
cl /nologo /Od /Zi /std:c++20 /FC /EHsc ..\..\Source\utils\shader_importer.cpp %include_dirs% /MD /link %lib_dirs% dxcompiler.lib spirv-cross-core.lib spirv-cross-glsl.lib /out:shader_importer.exe